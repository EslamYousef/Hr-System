...
namespace HR.Controllers
{
    ...
    public class Employee_experience_profileController : BaseController
    {
        ...
        public ActionResult Create(string id)
        {
            ...
            var EmployeeExperience = new Employee_experience_profile { Employee_Profile=emp,Employee_ProfileId=emp.ID.ToString(),Code=stru.Structure_Code +count.ToString(), Approval_date = statis, Start_date = DateTime.Now, End_date = DateTime.Now, Rejection_ReasonsId = "0", External_compainesId = "0" };
        ...
        public ActionResult Create(Employee_experience_profile model, string command)
        {
            try
            {
                ...
                record.Rejection_Reasons = dbcontext.Rejection_Reasons.FirstOrDefault(a => a.ID == Rejection_ReasonsId);
