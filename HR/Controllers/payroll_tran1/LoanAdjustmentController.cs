    ...
    public class LoanAdjustmentController : Controller
    {
        ...
        public ActionResult create(int id)
        {
            try
            {
                ...
                loan_adjustment.PaidAmount = loan.TotalPaidAmount;
                /////////////////////////////////
                ...
                var Our_model = new adjustmentVM { loan = loan, installment = installmentVM, adjustment = loan_adjustment };
            ...
            try
            {
                ...
                foreach (var item in selected)
                {
                    if (item != " ")
                    {
                        ...
                        if(spacial_installment.IsPaid==false)
                        {
