    ...
    public partial class d : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        ...
                        cities_ID = c.Int(),
                        Country_ID = c.Int(),
                        Employee_contact_profile_ID = c.Int(),
                        Employee_experience_profile_ID = c.Int(),
                        Employee_military_service_profile_ID = c.Int(),
                ...
                .ForeignKey("dbo.Countries", t => t.Country_ID)
                .ForeignKey("dbo.Employee_contact_profile", t => t.Employee_contact_profile_ID)
                .ForeignKey("dbo.Employee_experience_profile", t => t.Employee_experience_profile_ID)
                .ForeignKey("dbo.Employee_military_service_profile", t => t.Employee_military_service_profile_ID)
                ...
                .Index(t => t.cities_ID)
                .Index(t => t.Country_ID)
                .Index(t => t.Employee_contact_profile_ID)
                .Index(t => t.Employee_experience_profile_ID)
                .Index(t => t.Employee_military_service_profile_ID)
                ...
                c => new
                    {
                        ...
                        Employee_ProfileId = c.String(nullable: false),
                        Code = c.String(nullable: false),
                        External_compainesId = c.String(nullable: false),
                        Rejection_ReasonsId = c.String(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Employee_Profile", "Employee_military_service_profile_ID", "dbo.Employee_military_service_profile");
            ...
            DropForeignKey("dbo.Employee_Profile", "Employee_experience_profile_ID", "dbo.Employee_experience_profile");
            ...
            DropForeignKey("dbo.Employee_Profile", "Employee_contact_profile_ID", "dbo.Employee_contact_profile");
            ...
            DropIndex("dbo.Employee_Profile", new[] { "Employee_military_service_profile_ID" });
            DropIndex("dbo.Employee_Profile", new[] { "Employee_experience_profile_ID" });
            DropIndex("dbo.Employee_Profile", new[] { "Employee_contact_profile_ID" });
